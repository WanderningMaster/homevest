...
export const InputApartment: React.FC<IInputApartmentProps> = ({
  ...
  return (
    <div
      className={overrideTailwindClasses(clsx(
    ...
    >
      <input
        ...
        onChange={onChange}
        placeholder=" "
        className={overrideTailwindClasses(clsx("block  w-300px h-8.5 border-none p-2 font-body-small text-line-14 leading-line-14 text-green appearance-none focus:outline-none  bg-transparent",
         {
